...
class TeachersController extends AdminBaseController
{
    ...
    public function store()
    {
        ...
        $this->model->insert([
            ...
            'designation_bn'   => $this->request->getPost('designation_bn'),
            'department'       => $this->request->getPost('department'),
            'department_bn'    => $this->request->getPost('department_bn'),
            'subject'          => $this->request->getPost('subject'),
            'subject_bn'       => $this->request->getPost('subject_bn'),
            'qualification'    => $this->request->getPost('qualification'),
            'qualification_bn' => $this->request->getPost('qualification_bn'),
